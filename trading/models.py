...
class BybitMechanicalParameter(TimeStampedModel):
    """Bybit mechanical trading parameters - adjusted daily by LLM review"""
    ...
    # Scoring thresholds (entry conditions)
    ...
    # Scoring weights (how much each indicator counts)
    ...
    # Leverage (dynamic but start conservative)
...
class BybitMechanicalTrade(TimeStampedModel):
    """Track Bybit mechanical trades for performance analysis"""
